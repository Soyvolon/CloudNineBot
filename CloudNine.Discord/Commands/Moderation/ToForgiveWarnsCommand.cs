...
namespace CloudNine.Discord.Commands.Moderation
{
    ...
    {
        public partial class ForgiveCommands
        {
            [SlashCommand("list", "Lists the warns that are eligible for forgivness.")]
            [SlashRequireUserPermissions(Permissions.ManageMessages)]
            public async Task ToForgiveWarnsCommandAsync(InteractionContext ctx)
            {
